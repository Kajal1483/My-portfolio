...
function ParentR(props){
  return (<div class="row s-resume__section">
      ...
      <ResumeB link ="" projectName="Weather App" designation="Personal project" date="Sep-oct 2020"  details="Front-end- HTML,CSS,Javascript,Handlebars...Backend- Node.js, express.js" />
